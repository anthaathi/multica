  ...
  const groups: {
  ...
  }[] = [
    {
      ...
      entries: [
        ...
        },
        {
          ...
          description: t(($) => $.gitlab.connection_description),
        ...
        {
          id: "jira",
          label: t(($) => $.page.tabs.jira),
          description: t(($) => $.jira.connection_description),
          icon: <JiraMark className="size-5" />,
          content: <JiraTab />,
          state: jira,
        },
        ...(vcsAvailable
    ...
    },
    {
      ...
      entries: [
        ...
        {
          id: "mattermost",
          label: t(($) => $.mattermost.section_title),
          description: t(($) => $.mattermost.page_description),
          icon: <IntegrationChannelIcon channel="mattermost" />,
          content: <MattermostTab />,
          state: mattermost,
        },
        {
          id: "dingtalk",
