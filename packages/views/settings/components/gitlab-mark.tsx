// lucide-react v1.x dropped brand marks (including GitLab). Inline SVG of the
// official GitLab tanuki mark so the GitLab settings tab keeps a recognizable
// icon in the sidebar and section headers.
