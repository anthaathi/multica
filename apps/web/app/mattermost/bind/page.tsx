...
// Suspense wraps useSearchParams per Next.js 15's CSR-bailout rule; the
// loading text never paints in practice because the redemption page itself
// renders the "redeeming…" state immediately.
