...
// their adapters — slack.TypeSlack, mattermost.TypeMattermost and
// channel.TypeFeishu — and all sides agree on the wire strings below. WeCom
// keeps its reserved wire discriminator here until its adapter lands.
const (
