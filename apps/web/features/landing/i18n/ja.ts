      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "Multica は Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DevEco Code、Grok、Hermes、Kimi、Kiro CLI、OpenClaw、OpenCode、Pi、Oh My Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI という21種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "multica setup を実行すると、OAuth の手順を案内し、デーモンを起動し、21種類の対応コーディングツール(Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DevEco Code、Grok、Hermes、Kimi、Kiro CLI、OpenClaw、OpenCode、Pi、Oh My Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI)をスキャンします。すでにインストール済みのものは、自動的にランタイムとして登録されます。",
        },
        {
          title: "最初のエージェントを作成",
          description:
      ...
      items: [
        {
          ...
          answer:
            "Multica は、Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DevEco Code、Grok、Hermes、Kimi、Kiro CLI、OpenClaw、OpenCode、Pi、Oh My Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI の21種類のコーディングツールに標準対応しています。デーモンが、すでにインストール済みの CLI を自動検出し、それぞれをランタイムとして登録します。オープンソースなので、独自のバックエンドを追加することもできます。",
        },
        {
