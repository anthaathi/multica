...
// Trae, Grok, Oh My Pi, Qwen Code, QwenPaw, MiniMax Code). It
...
type Config struct {
	ExecutablePath string            // path to CLI binary (claude, codebuddy, codex, copilot, opencode, codearts, openclaw, hermes, pi, cursor, kimi, reasonix, dsh, kiro-cli, agy, qodercli, qoderclicn, traecli, omp, grok, qwen, qwenpaw, mcode, dim, zeroclaw)
...
// Supported types: "claude", "codebuddy", "codex", "copilot", "opencode", "codearts", "deveco", "openclaw", "hermes", "pi", "cursor", "kimi", "reasonix", "dsh", "kiro", "antigravity", "qoder", "qoderclicn", "traecli", "omp", "grok", "qwen", "qwenpaw", "mcode", "dim", "zeroclaw".
//
...
// to add qwenpaw, migration 254 to add reasonix, migration 313 to add
// dsh, migration 342 to add mcode, migration 370 to add dim, migration 403
// to add zeroclaw, and migration 441 to add codearts): a custom runtime
