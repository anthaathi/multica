...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"gitlab_connection":               workspaceDelete,
	"gitlab_merge_request":            workspaceDelete,
	"gitlab_merge_request_pipeline":   workspaceDelete,
	"gitlab_pending_pipeline":         workspaceDelete,
	"inbox_item":                      workspaceDelete,
	"issue":                           workspaceDelete,
	"issue_dependency":                workspaceDelete,
	"issue_label":                     workspaceDelete,
	"issue_merge_request":             workspaceDelete,
