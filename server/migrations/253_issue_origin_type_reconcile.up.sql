...
-- -> 191 -> 197 -> 202 -> 203 -> 214 -> 224 -> 253 as upstream claimed prefix 157
...
-- (214_chat_session_project, sync 2026-07-25), then 224
-- (224_agent_task_session_rollout_missing, sync 2026-08-03); runs last so the
